...
public class CipherServiceImplTest {
  ...
  @Test(expected = NullPointerException.class)
  public void testDeccryptShouldThrowNPEWhenEncryptedIsNull() throws Exception {
    this.sut.decrypt(null);
    fail("Decrypt should have thrown a NullPointerException");
  }

  @Test(expected = DecryptionException.class)
  public void testDecryptShouldThrowDecryptionExceptionWhenKeyIsInvalid() throws Exception {
    this.sut = new CipherServiceImpl(INVALID_BASE64_KEY, INVALID_BASE64_IV);

    this.sut.decrypt(ENCRYPTED);

    fail("Decrypt should have thrown DecryptionException");
  }

  @Test
  public void testDecryptShouldDecryptData() throws Exception {
    String result = this.sut.decrypt(ENCRYPTED);
