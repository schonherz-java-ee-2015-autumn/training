...
public class MandatoryPasswordConfirmationRuleTest {

  private static final Violation VIOLATION = new Violation("passwordConfirmation",
      "Password confirmation must be entered");

  private MandatoryPasswordConfirmationRule sut;
  private AccountRegistrationRequest request;

  @DataPoints
  public static final String[] passwordConfirmationToReject = {null, "", " \n\t"};

  @Before
  public void setUp() throws Exception {
    this.sut = new MandatoryPasswordConfirmationRule();
  ...
  @Test
  public void testValidateShouldIgnoreNotPasswordConfirmationFields() throws Exception {
  ...
  @Theory
  public void testValidateShouldRejectValue(String passwordConfirmation) throws Exception {
